...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuFrameMap.put("Beef Burger", R.id.btnMenu1_container);
        menuFrameMap.put("beef burger", R.id.btnMenu1_container);
        menuFrameMap.put("Lemon Cola", R.id.btnMenu2_container);
        menuFrameMap.put("lemon cola", R.id.btnMenu2_container);
        menuFrameMap.put("Kentucky", R.id.btnMenu3_container);
        menuFrameMap.put("kentucky", R.id.btnMenu3_container);
        menuFrameMap.put("French Fries", R.id.btnMenu4_container);
        menuFrameMap.put("french fries", R.id.btnMenu4_container);
